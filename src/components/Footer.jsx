...
function SocialIcon({ href, label, children }) {
 return (
  ...
  href={href}
  aria-label={label}
  className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-white/80 shadow-sm transition-all duration-300 hover:scale-105 hover:bg-[#079447] hover:shadow-md [&>svg]:hover:text-white"
  >
  {children}
  </a>
 );
...
export default function Footer() {
 ...
 return (
  <footer className="relative z-10 bg-gradient-to-b from-gray-50 via-gray-100 to-gray-200 text-slate-700 py-10 px-6 md:px-8 border-t-2 border-[#079447]">
...
<h4 className="text-xs font-manrope font-semibold mb-4 text-slate-500 uppercase tracking-widest">
  ...
  <div className="flex flex-col md:flex-row items-center justify-between gap-6 py-6 border-t border-slate-300/70">
