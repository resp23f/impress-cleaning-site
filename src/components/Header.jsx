          ...
          <div className="flex items-center justify-between gap-2 flex-nowrap py-2 lg:py-3 2xl:py-4">
            ...
            >
              ...
              <div className="flex items-center gap-3 ml-auto">
                ...
                <Link
                  href="/auth/login"
                  className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl border border-slate-300 text-slate-700 text-[15px] font-semibold hover:border-[#079447] hover:text-[#079447] hover:bg-white transition-all duration-300 font-manrope whitespace-nowrap"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
