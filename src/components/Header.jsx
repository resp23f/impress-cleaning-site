...
<div className="flex items-center gap-2 flex-nowrap py-2 lg:py-3 2xl:py-4">
  {/* LOGO */}
  <Link
    href="/"
    className="flex items-center select-none shrink-0 relative z-10 -ml-2 md:ml-0"
...
<nav className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
  <div className="flex items-center justify-center gap-[clamp(2px,1vw,24px)]">
    <Link href="/" className="relative font-display px-2 lg:px-3 xl:px-4 py-2 rounded-full transition-all duration-300 ease-out hover:bg-green-50/60 hover:text-[#079447] hover:shadow-sm hover:-translate-y-[1px]">
      Home
    </Link>
    <Link href="/residential-section" className="relative font-display px-2 lg:px-3 xl:px-4 py-2 rounded-full transition-all duration-300 ease-out hover:bg-green-50/60 hover:text-[#079447] hover:shadow-sm hover:-translate-y-[1px]">
      Residential
    </Link>
    <Link href="/commercial" className="relative font-display px-2 lg:px-3 xl:px-4 py-2 rounded-full transition-all duration-300 ease-out hover:bg-green-50/60 hover:text-[#079447] hover:shadow-sm hover:-translate-y-[1px]">
      Commercial
    </Link>
    <Link href="/gift-certificate" className="relative font-display px-2 lg:px-3 xl:px-4 py-2 rounded-full transition-all duration-300 ease-out hover:bg-green-50/60 hover:text-[#079447] hover:shadow-sm hover:-translate-y-[1px]">
      <span className="hidden xl:inline">Gift Certificates</span>
      <span className="xl:hidden">Gifts</span>
    </Link>
    <Link href="/faq" className="relative font-display px-2 lg:px-3 xl:px-4 py-2 rounded-full transition-all duration-300 ease-out hover:bg-green-50/60 hover:text-[#079447] hover:shadow-sm hover:-translate-y-[1px]">
      FAQ
    </Link>
    <Link href="/about-us" className="relative font-display px-2 lg:px-3 xl:px-4 py-2 rounded-full transition-all duration-300 ease-out hover:bg-green-50/60 hover:text-[#079447] hover:shadow-sm hover:-translate-y-[1px]">
...
<div className="hidden md:flex items-center gap-0.5 lg:gap-1 xl:gap-2 2xl:gap-3 ml-auto shrink-0">
  <Link href="/booking" className="inline-flex items-center justify-center px-3 lg:px-4 xl:px-6 py-2 lg:py-2.5 xl:py-3 rounded-xl font-bold text-white text-[13px] lg:text-[14px] xl:text-[15px] bg-gradient-to-r from-[#079447] to-[#08A855] hover:shadow-lg hover:shadow-green-500/20 hover:scale-[1.05] transition-all duration-300 font-manrope whitespace-nowrap">
    <span className="hidden sm:inline">Book Now</span>
    <span className="sm:hidden">Book</span>
  </Link>
  
  <Link href="/auth/login" className="inline-flex items-center justify-center gap-1 px-2.5 lg:px-3 xl:px-5 py-2 lg:py-2.5 xl:py-3 rounded-xl border border-slate-300 text-slate-700 text-[13px] lg:text-[14px] xl:text-[15px] font-semibold hover:border-[#079447] hover:text-[#079447] hover:bg-white transition-all duration-300 font-manrope whitespace-nowrap">
  ...
  <div className="relative">
    <button
      ...
      className={`inline-flex items-center justify-center w-8 lg:w-9 xl:w-10 2xl:w-11 h-8 lg:h-9 xl:h-10 2xl:h-11 rounded-full border transition-all duration-200 ${
        desktopMenuOpen ? "border-slate-400 bg-slate-50 shadow-sm" : "border-slate-300 bg-white hover:border-slate-400 hover:shadow-sm"
      }`}
    >
      <svg className="w-3.5 lg:w-4 xl:w-5 h-3.5 lg:h-4 xl:h-5 text-slate-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
