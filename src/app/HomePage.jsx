...
function WhyChoose() {
 ...
 const PortalIcon = () => (
  <svg className="w-12 h-12" viewBox="0 0 64 64" fill="none">
   <circle cx="32" cy="22" r="10" fill="#079447" />
   <path d="M16 52c0-8.837 7.163-16 16-16s16 7.163 16 16" fill="#079447" />
   <rect x="38" y="34" width="18" height="14" rx="2" fill="#0B5D2E" />
   <rect x="40" y="37" width="6" height="2" rx="1" fill="#4ADE80" />
   <rect x="40" y="41" width="10" height="2" rx="1" fill="#4ADE80" />
   <rect x="40" y="45" width="8" height="2" rx="1" fill="#4ADE80" />
   <circle cx="50" cy="30" r="6" fill="#079447" stroke="white" strokeWidth="2" />
   <path d="M47 30l2 2 4-4" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
 );
 const cards = [
  {
  ...
  },
  {
   ...
   bgColor: 'bg-green-50',
   iconBg: 'bg-green-100',
   alt: 'Customer portal for managing appointments and invoices'
  },
  {
   t: 'Locally Owned',
    ...
    <StaggerItem>
     <div className="text-center mb-12">
      ...
      <p className="text-xl text-gray-600 max-w-2xl mx-auto">
       Five reasons families choose us to care for their homes
      </p>
     </div>
    </StaggerItem>
