...
export default function DashboardPage() {
 ...
 return (
  ...
  {/* Premium Background */}
  <div
  className={`min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 ${styles.contentReveal}`}
  >
                       ...
                       {profile?.created_at
                        ...
                        {(() => {
                         ...
                         return (
                          ...
                          <div
                          className={`h-full ${
                           freshness.barColor || 'bg-gray-300'
