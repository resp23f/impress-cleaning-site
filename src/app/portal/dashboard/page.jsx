   ...
   {nextAppointment ? (
    ...
    className={`
     ...
     <div className={`
                ...
                shadow-[0_1px_3px_rgba(0,0,0,0.05),0_20px_40px_-15px_rgba(0,0,0,0.1)]
                ${balance > 0 
      ? 'bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 border border-amber-200/50' 
     ...
     <div className={`
                  ...
                  ${balance > 0 ? 'bg-amber-300' : 'bg-emerald-300'}
                `} />
      <div className={`
                  absolute -bottom-8 -left-8 w-32 h-32 rounded-full opacity-10
                  ${balance > 0 ? 'bg-orange-300' : 'bg-green-300'}
                `} />
            ...
            .map((invoice) => {
             ...
             return (
              ...
              className={`
                              ...
                              hover:border-[#079447]/30 hover:shadow-md
                              ${styles.smoothTransition}
                            `}
               >
