   ...
   <div className="py-8 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto space-y-8">
    ...
    <Card padding="lg" className={`space-y-4 !rounded-2xl !shadow-[0_1px_3px_rgba(0,0,0,0.05),0_10px_30px_-10px_rgba(0,0,0,0.08)] border border-gray-100/80 ${styles.cardReveal4}`}>
     ...
     <div className="space-y-3">
      ...
      {addresses.map((addr) => (
       <div key={addr.id} className="border border-gray-200 rounded-xl p-5 flex flex-col sm:flex-row sm:items-start justify-between gap-4 bg-gradient-to-br from-white to-gray-50/50 hover:shadow-md transition-all duration-200">
     ...
     <div className={`grid grid-cols-1 ${payments.length > 0 ? 'lg:grid-cols-3' : 'lg:grid-cols-2'} gap-4`}>
      <div className={payments.length > 0 ? 'lg:col-span-2 space-y-3' : ''}>
       {payments.length === 0 ? (
        ...
        payments.map((pm) => (
         <div key={pm.id} className="border border-gray-200 rounded-xl p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-gradient-to-br from-white to-gray-50/50 hover:shadow-md transition-all duration-200">
     ...
     <div className="mt-6 pt-5 border-t border-gray-100">
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8">
       <div className="flex items-center gap-2">
        <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center shadow-md">
         <ShieldCheck className="w-3.5 h-3.5 text-emerald-400" />
        </div>
        <div className="text-left">
         <p className="text-xs font-bold text-[#1C294E]">256-bit SSL</p>
         <p className="text-[10px] text-gray-500">Encryption</p>
        </div>
       </div>
       <div className="flex items-center gap-2">
        <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-indigo-600 to-purple-700 flex items-center justify-center shadow-md">
         <Lock className="w-3.5 h-3.5 text-white" />
        </div>
        <div className="text-left">
         <p className="text-xs font-bold text-[#1C294E]">Stripe Secure</p>
       ...
       <div className="flex items-center gap-2">
        ...
        <div className="text-left">
         <p className="text-xs font-bold text-[#1C294E]">Bank-Level</p>
