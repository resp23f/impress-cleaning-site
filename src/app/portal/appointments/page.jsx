...
const handleCancel = async () => {
 ...
 if (isWithin48Hours(selectedAppointment)) {
  toast.error('Appointments within 48 hours cannot be cancelled online. Please contact our office.')
  return
 }
...
return (
 ...
 isOpen={!!modalMode}
 onClose={closeModal}
 title={modalMode === 'reschedule' ? 'Reschedule appointment' : 'Cancel appointment'}
 >
