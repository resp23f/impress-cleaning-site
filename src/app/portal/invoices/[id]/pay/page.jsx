...
`}
      ...
      <Button
        ...
        className="!py-4 !bg-gradient-to-r !from-emerald-500 !to-teal-500 shadow-lg shadow-emerald-500/25 !transition-none"
      >
                    ...
                    <div className="bg-gradient-to-br from-slate-50 to-slate-100/50 border border-slate-200 rounded-xl p-6 mb-6">
                      ...
                      <div className="space-y-4">
                        <div className="p-4 bg-white rounded-xl border border-slate-100">
                          ...
                          <p className="text-lg font-bold text-emerald-600">
                            billing@impressyoucleaning.com
                          </p>
                        </div>
                      ...
                      <div className="mt-5 p-4 bg-white rounded-xl border border-slate-100">
                        ...
                        <ol className="text-sm text-slate-600 space-y-1.5 list-decimal list-inside">
                          ...
                          <li>Send to <strong className="text-slate-800">billing@impressyoucleaning.com</strong></li>
        ...
        >
          <div className="space-y-4">
            <p className="text-slate-600">
              Please confirm that you have sent <strong className="text-slate-800">{formatMoney(invoice?.total ?? invoice?.amount)}</strong> via Zelle to <strong className="text-slate-800">billing@impressyoucleaning.com</strong> with reference <strong className="text-slate-800">{invoice.invoice_number}</strong>.
            </p>            <div className="bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-100 rounded-xl p-4">
