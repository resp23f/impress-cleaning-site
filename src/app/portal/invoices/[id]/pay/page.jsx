  ...
  return (
    <div className="py-8 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          ...
          <Card>
            ...
            {paymentMethod === 'stripe' && (
              <div>
                ...
                >
                  <CreditCard className="w-5 h-5" />
                  Pay ${parseFloat(invoice.amount).toFixed(2)}
                </Button>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
                  ...
                  <div className="mt-6 p-4 bg-white rounded-lg">
                    ...
                    <ol className="text-sm text-gray-600 mt-2 space-y-1 list-decimal list-inside">
                      ...
                      <li>Enter amount: <strong>${parseFloat(invoice.amount).toFixed(2)}</strong></li>
                      <li>Include invoice number: <strong>{invoice.invoice_number}</strong></li>
      ...
      >
        <div className="space-y-4">
          <p className="text-gray-600">
            Please confirm that you have sent <strong>${parseFloat(invoice.amount).toFixed(2)}</strong> via Zelle to <strong>payments@impresscleaning.com</strong> with reference <strong>{invoice.invoice_number}</strong>.
          </p>
