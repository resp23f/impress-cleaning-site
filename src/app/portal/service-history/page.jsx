  ...
  const DatePicker = ({ label, field }) => {
    ...
    return (
      <div className="min-w-0">
        ...
        {/* Pretty box instead of native input */}
        <button
          type="button"
          onClick={() => toggle(!open)}
          className={`
            w-full box-border rounded-xl border border-gray-200 px-4 py-2.5
        ...
        {open && (
          <div className="relative">
            <div className="absolute z-50 mt-2 w-full bg-white rounded-xl shadow-xl border border-gray-200 p-4">
              {/* Calendar header */}
              ...
              >
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <div className="flex flex-wrap gap-3 pt-6 border-t border-gray-100">
                    {svc.invoice && (
                      <Link
                        href={`/portal/invoices?focus=${svc.invoice.id}`}
                    ...
                    {svc.invoice?.id && (
                      <Link
                        href={`/portal/invoices/${svc.invoice.id}/pay`}
                        className="flex-1 min-w-[140px]"
                      >
                        <Button
                          variant="secondary"
