            ...
            <div className="space-y-4">
              ...
              <label className="flex items-center gap-3 p-4 border-2 rounded-lg cursor-pointer hover:border-[#079447] transition-colors">
                <input
                  ...
                  className="w-5 h-5 text-[#079447] focus:ring-[#079447] rounded"
                />
                <div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        {step === 4 && (
          <div>
            ...
            <textarea
              ...
              rows={6}
              className="w-full px-4 py-3 rounded-lg border-2 border-gray-200 focus:border-[#079447] focus:outline-none focus:ring-2 focus:ring-[#079447]/20 transition-all duration-200 resize-none"
            />
            <div className="flex gap-3 mt-6">
              <Button
                variant="secondary"
        ...
        {step === 5 && (
          <div>
            ...
            <label className="flex items-center gap-3 p-4 border-2 rounded-lg cursor-pointer hover:border-[#079447] transition-colors mb-4">
              <input
                type="checkbox"
