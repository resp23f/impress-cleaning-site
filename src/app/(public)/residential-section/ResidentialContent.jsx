...
export default function ResidentialContent() {
 return (
  ...
  {/* Breadcrumbs */}
  <Breadcrumbs
  items={[{ label: 'Residential Cleaning', href: '/residential-section' }]}
  />
  ...
  Professional cleaning services for Austin, Cedar Park, Round Rock, Georgetown and nearby areas. 
  We bring eco friendly solutions and meticulous attention to detail to every home we serve. 
  Because maintaining a clean, healthy home isn&apos;t a luxury, it&apos;s a necessity that deserves professional care.
  </p>
  ...
  <div className="max-w-7xl mx-auto">
  <div className="bg-[var(--softgreen)] rounded-3xl p-8 md:p-12 lg:p-16 shadow-2xl border border-green-200/30">
  <div className="text-center mb-16">
  <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-gray-900 mb-4">
  How It Works
  </h2>
  <p className="text-lg sm:text-xl text-gray-600 font-manrope max-w-2xl mx-auto">
  ...
  {/* Left Content */}
  <div>
  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold font-display text-gray-900 mb-6 leading-tight">
  ...
  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 font-display leading-tight">
  Ready to Experience the Impress Difference?
  </h2>
  <p className="text-lg sm:text-xl text-[#1C294E] mb-10 font-semibold font-manrope leading-relaxed">
