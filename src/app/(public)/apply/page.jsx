    ...
    <div className="min-h-screen bg-[#FAFAF8]">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#001F3F] via-[#0B2859] to-[#001F3F] min-h-[85vh] flex items-center">
        ...
        <div className="absolute inset-0 overflow-hidden">
          {/* Gradient orbs */}
          <div className="absolute top-20 left-10 w-72 h-72 bg-[#079447]/20 rounded-full blur-3xl animate-blob" />
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-[#079447]/15 rounded-full blur-3xl animate-blob animation-delay-2000" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#079447]/10 rounded-full blur-3xl animate-blob animation-delay-4000" />
          ...
          <div className="max-w-4xl">
            ...
            <AnimatedSection delay={0}>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-8">
                ...
                <span className="text-sm font-medium text-white/90">We're Hiring — Join Our Growing Team</span>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={200}>
              <p className="text-xl sm:text-2xl text-blue-100/90 mb-10 max-w-2xl leading-relaxed">
                Join a team where your work makes a difference every single day. 
                Great pay, flexible hours, and real opportunities to grow.
              </p>
            </AnimatedSection>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                We offer more than just a job — it's an opportunity to be part of something special
              </p>
            </div>
          </AnimatedSection>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((benefit, index) => {
              ...
              return (
                <AnimatedSection key={index} delay={index * 100}>
                  <div className="group relative bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-xl hover:border-[#079447]/20 transition-all duration-500 hover:-translate-y-1">
                    {/* Icon */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Choose a position that matches your skills and interests. No experience? No problem — we'll train you.
              </p>
            </div>
          </AnimatedSection>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            {jobs.map((job, index) => (
              <AnimatedSection key={job.id} delay={index * 150}>
                <div className="group relative bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:border-[#079447]/20 transition-all duration-500 overflow-hidden">
                  {/* Highlight badge */}
                  {job.highlight && (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our hiring process is quick and straightforward. Most candidates hear back within 48 hours.
              </p>
            </div>
          </AnimatedSection>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            ...
            <p className="text-xl text-blue-100/90 mb-10 max-w-2xl mx-auto">
              Join a company that values its employees as much as its customers. 
