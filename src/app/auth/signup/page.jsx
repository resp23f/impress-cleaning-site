...
>                {googleLoading ? (
              ...
              <p className="text-center text-xs text-slate-300 mt-6 leading-relaxed">
                ...
                <a href="https://policies.google.com/privacy" className="hover:text-slate-400" target="_blank" rel="noopener noreferrer">
                  Privacy
                </a>
                {' · '}
                <a href="https://policies.google.com/terms" className="hover:text-slate-400" target="_blank" rel="noopener noreferrer">
                  Terms
                </a>
              </p>
            </div>
