        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.08)] border border-white/60 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-[#079447] to-emerald-500 px-8 py-8">
            <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
              <img src="/logo_impress.png" alt="Impress" className="w-12 h-12 object-contain" />
            </div>
          ...
          <div className="px-8 py-6">
            ...
            <button
              ...
              className="w-full py-3.5 rounded-2xl bg-white border border-gray-200 hover:bg-gray-50 hover:border-gray-300 text-[#1C294E] font-medium transition-all duration-200 flex items-center justify-center gap-3 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {googleLoading ? (
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center">
                <span className="px-4 bg-transparent text-sm text-gray-400">or sign up with email</span>
              </div>
            </div>
            ...
            <p className="text-center text-sm text-gray-600 mt-6">
              ...
              <Link href="/auth/login" className="text-[#079447] font-semibold hover:underline">
                Log in
              </Link>
            </p>
          </div>
          ...
          <div className="px-8 py-4 bg-gray-50/50 border-t border-gray-100">
            <p className="text-xs text-gray-400 text-center leading-relaxed">
              ...
              <a href="https://policies.google.com/privacy" className="underline hover:text-gray-600" target="_blank" rel="noopener noreferrer">
                Privacy Policy
              </a>{' '}
              &{' '}
              <a href="https://policies.google.com/terms" className="underline hover:text-gray-600" target="_blank" rel="noopener noreferrer">
                Terms
              </a>
            </p>
          </div>
