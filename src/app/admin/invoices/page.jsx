...
export default function InvoicesPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100">
      ...
      <Modal isOpen={showCreateModal} onClose={() => setShowCreateModal(false)} title="Create New Invoice" maxWidth="2xl">
        <div className="space-y-6">
          {/* Customer Selection */}
          <div>
            ...
            {['zelle', 'cash', 'check'].map((method) => (
              <label
                ...
                className={`flex items-center gap-3 p-4 border-2 rounded-xl cursor-pointer transition-all ${
                  paymentMethod === method ? 'border-[#079447] bg-[#079447]/5' : 'border-gray-200 hover:border-gray-300'
                }`}
              >
                <input
                  type="radio"
