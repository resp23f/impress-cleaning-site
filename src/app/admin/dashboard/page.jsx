        ...
        <main className="py-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <Card>
              ...
              <Link href="/admin/invoices" className="text-sm text-yellow-600 mt-2 hover:underline inline-block">
                View details →
              </Link>
            </Card>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/admin/customers" className="text-sm text-[#079447] font-medium hover:underline">
                  View All
                </Link>
              </div>
